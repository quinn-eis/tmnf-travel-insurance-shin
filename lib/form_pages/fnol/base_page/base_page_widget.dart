...
class _BasePageWidgetState extends State<BasePageWidget> {
  ...
  void initState() {
    ...
    _model.datePickerTextController ??=
        TextEditingController(text: _model.dateStr);
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '3inbimr1' /* *indicates a required question */,
                                  ),
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'v0yndioc' /* Section Title (Dropdown) */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'vwlwg476' /* Section Title (Radio List) */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '92c6p3aq' /* Section Title (Checkbox Group) */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
