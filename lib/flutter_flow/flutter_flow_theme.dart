...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0085C3);
  late Color secondary = const Color(0xFFBC851C);
  late Color tertiary = const Color(0xFF0AAAF5);
  late Color alternate = const Color(0xFFCC0000);
  ...
  late Color lineColor = Color(0xFFDDDDDD);
  late Color borderColor = Color(0xFF788598);
  late Color seperationColor = Color(0xFFC7C7C8);
  late Color errorBackground = Color(0x70FCBBBF);
  late Color disabledButton = Color(0xFF788598);
